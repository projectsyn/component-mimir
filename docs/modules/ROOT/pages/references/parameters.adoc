...
IMPORTANT: This version of the component does not support Helm charts < v5.x!
...
[TIP]
====
This will configure ingress for either nginx or gateway.
If both are enabled, nginx takes precedence.
====
