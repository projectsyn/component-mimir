# Commodore Component: mimir

This is a [Commodore][commodore] Component for mimir.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/mimir).
