...
instance ?= defaults
test_instances = tests/defaults.yml tests/openshift.yml tests/legacy.yml tests/extra-config.yml tests/preset-small.yml tests/preset-large.yml
